...
| Node Name  | CPU Model         | Cores | RAM  | GPU Model | GPUs | Storage  |
|------------|------------------|-------|------|-----------|------|----------|
| prism-1    | AMD EPYC 7742    | 128   | 1TB  | A100 80GB | 8    | 10TB SSD |
| prism-2    | AMD EPYC 7742    | 128   | 1TB  | A100 80GB | 8    | 10TB SSD |
| prism-3    | AMD EPYC 7742    | 128   | 1TB  | A100 80GB | 8    | 10TB SSD |
| prism-4    | AMD EPYC 7742    | 128   | 1TB  | A100 80GB | 8    | 10TB SSD |
