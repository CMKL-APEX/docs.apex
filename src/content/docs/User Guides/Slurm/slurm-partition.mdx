...
<Aside type="danger" title="Out of Service">
  Slurm is no longer used on the APEX system and this service has been discontinued. The content below is kept for historical reference only.
</Aside>
