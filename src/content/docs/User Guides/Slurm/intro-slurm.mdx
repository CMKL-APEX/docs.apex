...
Slurm is no longer used on the APEX system and this service has been discontinued. The content below is kept for historical reference only. Please refer to the current documentation for the workload manager in use.
:::
